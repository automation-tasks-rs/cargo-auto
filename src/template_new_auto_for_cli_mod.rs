...
//! <https://github.com/automation-tasks-rs/cargo_auto_template_new_auto_for_cli/releases/download/v1.0.0/template.tar.gz>
...
pub fn copy_to_files(rust_project_name: &str) {
    ...
    let url = "https://github.com/automation-tasks-rs/cargo_auto_template_new_auto_for_cli/releases/download/v1.0.0/template.tar.gz";
