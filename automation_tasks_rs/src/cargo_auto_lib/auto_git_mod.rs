...
pub fn new_local_repository(message: &str) -> Result<()> {
    ...
    crate::cargo_auto_lib::run_shell_command_static("git config --global init.defaultBranch main")?;
    crate::cargo_auto_lib::run_shell_command_static("git init")?;
    crate::cargo_auto_lib::run_shell_command_static("git add .")?;
    crate::cargo_auto_lib::run_shell_command(&format!(r#"git commit -m "{message}""#))?;
    crate::cargo_auto_lib::run_shell_command_static("git branch -M main")?;
    Ok(())
}
