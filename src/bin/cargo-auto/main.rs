...
//! ***version: 2025.1108.909 date: 2025-11-08 author: [bestia.dev](https://bestia.dev) repository: [GitHub](https://github.com/automation-tasks-rs/cargo-auto)***
//!
...
//!
//! [![Lines in Rust code](https://img.shields.io/badge/Lines_in_Rust-1011-green.svg)](https://github.com/automation-tasks-rs/cargo-auto/)
//! [![Lines in Doc comments](https://img.shields.io/badge/Lines_in_Doc_comments-616-blue.svg)](https://github.com/automation-tasks-rs/cargo-auto/)
//! [![Lines in Comments](https://img.shields.io/badge/Lines_in_comments-132-purple.svg)](https://github.com/automation-tasks-rs/cargo-auto/)
...
use cargo_auto_main_lib::{self as lib, pos};
...
fn main_returns_anyhow_result() -> anyhow::Result<()> {
    ...
    if lib::is_not_run_in_rust_project_root_directory() {
        lib::outside_of_rust_project_mod::parse_args(&mut args).log(pos!())?;
    } else {
        lib::inside_of_rust_project_mod::parse_args(&mut args).log(pos!())?;
    }
    Ok(())
}
